        ...
        <div className="flex flex-col items-center gap-3">
          {shop?.logoUrl ? (
            ...
            <img
              src={shop.logoUrl}
              alt={`Logo ${shop.name}`}
              className="h-16 w-16 rounded-full object-cover ring-2 ring-[#c4a574]/50"
            />
          ) : (
          ...
          <div className="flex items-start gap-3">
            {shop?.logoUrl && (
              ...
              <img
                src={shop.logoUrl}
                alt=""
                className="mt-0.5 hidden h-12 w-12 shrink-0 rounded-lg object-cover sm:block"
              />
            )}
          ...
          {shopError && (
            <div className="mt-6 space-y-3">
              <p className="text-neutral-700">
                ...
                <span className="font-mono text-sm">{bookingPath(slug)}</span>.
              </p>
            </div>
          )}
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  className="w-full"
                  disabled={
                    !name || !whatsapp || book.isPending || book.isSuccess
                  }
                  onClick={() => {
