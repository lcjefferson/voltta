...
export default function LoginPage() {
  return (
    <main className="grid min-h-screen bg-[#f7f6f2] md:grid-cols-2">
      <aside className="hidden bg-[#171715] p-12 text-white md:block">
        ...
        <div className="mt-48 max-w-sm">
          ...
          <p className="mt-6 text-white/60">
            Retenção para barbearias, salões e profissionais de estética.
          </p>
        </div>
      </aside>
