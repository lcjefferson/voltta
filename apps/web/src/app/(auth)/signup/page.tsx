...
export default function SignupPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#171715] p-6">
      <div className="w-full max-w-md rounded-xl bg-[#f7f6f2] p-7 md:p-10">
        ...
        <h1 className="mt-2 font-display text-5xl">VAMOS CRESCER.</h1>
